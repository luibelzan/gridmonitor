            ...
            <div class="lg:ml-14 p-2 mt-0 w-full"> <!-- Añadir margen superior -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-4 mt-16 ml-14">
                    ...
                    <nav class="nav mb-12 ">
                        ...
                        <a href="{{ route('curvashorariaspf', ['id_cnt' => $id_cnt]) }}" class="nav-item is-active"
                    ...
                    @if ($id_cnt)
                        ...
                        @else
                            <h1 class="text-center text-3xl w-full" style="color: white;">CURVAS HORARIAS</h1>
                            <div
                                ...
                                @if ($cnt->id_cnt == $id_cnt)
                                    ...
                                    <div class="container ">
                                        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-6 gap-6 mb-4">
                                            ...
                                            <div class="card text-white mb-2 lg:col-span-3" style="background: linear-gradient(to bottom, RGB(27 32 38), RGB(27 32 38));">
                                                <div class="container mt-4 justify-center items-center flex flex-col">
                                                    <div class="form-group">
                                                        <form action="{{ route('curvashorariaspf', ['id_cnt' => $id_cnt]) }}" method="GET"
                                            ...
                                            {{-- Nº CURVAS HORARIAS SIN CONSUMO --}}
                                            <div class="card text-white mb-2 lg:col-span-1" style="background: linear-gradient(to bottom, RGB(27 32 38), RGB(27 32 38));">
                                                <div class="flex flex-col items-center justify-center text-center m-2 p-2 rounded-lg">
                                                    <h2 class="text-white">Nº CURVAS HORARIAS SIN CONSUMO</h2>
                                                    <div class="#205E86 text-white rounded-lg shadow-xl">
                                                        <p class="mt-2 text-{{ count($resultadosQ12pf) > 0 && !empty($resultadosQ12pf[0]->Energia_Activa_Importada_A) ? '5xl' : '5xl' }}"
                                                            style="color:rgb(248,73,90)">
                                                            {{ count($resultadosQ12pf) > 0 && !empty($resultadosQ12pf[0]->Energia_Activa_Importada_A) ? number_format($resultadosQ12pf[0]->Energia_Activa_Importada_A, 0, '.', '.') : '0' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card text-white mb-2 lg:col-span-1" style="background: linear-gradient(to bottom, RGB(27 32 38), RGB(27 32 38));">
                                                <div class="flex flex-col items-center justify-center text-center m-2 p-2 rounded-lg">
                                                    ...
                                                    <div class="#205E86 text-white rounded-lg shadow-xl">
                                                        <p class="mt-4 text-{{ count($resultadosQ13pf) > 0 && !empty($resultadosQ13pf[0]->suma_importada) ? '5xl' : '4xl' }}"
                                                            style="color:rgb(88,226,194)">
                                                            {{ count($resultadosQ13pf) > 0 && !empty($resultadosQ13pf[0]->suma_importada) ? number_format($resultadosQ13pf[0]->suma_importada, 0, '.', '.') : '0' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card text-white mb-2 lg:col-span-1" style="background: linear-gradient(to bottom, RGB(27 32 38), RGB(27 32 38));">
                                                <div class="flex flex-col items-center justify-center text-center m-2 p-2 rounded-lg">
                                                    <h2 class="text-white">Kwh (A-)</h2>
                                                    <div class="#205E86 text-white rounded-lg shadow-xl">
                                                        <p class="mt-4 text-{{ count($resultadosQ14pf) > 0 && !empty($resultadosQ14pf[0]->suma_exportada) ? '5xl' : '5xl' }}"
                                                            style="color:rgb(88,226,194)">
                                                            {{ count($resultadosQ14pf) > 0 && !empty($resultadosQ14pf[0]->suma_exportada) ? number_format($resultadosQ14pf[0]->suma_exportada, 0, '.', '.') : '0' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card text-white  mb-2"
                                                ...
                                                <div class="container">
                                                    <div class="table-responsive w-full"
                                                        ...
                                                        @if (is_array($resultadosQ8pf) && count($resultadosQ8pf) > 0)
                                                            <div class="grafico-wrapper"
                                                                ...
                                                                <canvas id="graficoCurvasHorarias"
                                                                    class="w-full"></canvas>
                                                            </div>
                                                            {{-- SCRIPTS PARA EL GRÁFICO CURVAS HORARIAS --}}
                                                            <script>
                                                                var labels_curvashorarias = [];
                                                                var values_curvashorarias_A = [];
                                                                var values_curvashorarias_Ri = [];
                                                                var values_curvashorarias_Exportada_A = []; // Nuevo array para Energia_Activa_Exportada_A
                                                            
                                                                @foreach ($resultadosQ8pf as $resultado)
                                                                    var dateTime = '{{ $resultado->Fecha }} {{ $resultado->Hora }}';
                                                                    labels_curvashorarias.push(dateTime);
                                                                    values_curvashorarias_A.push({{ $resultado->Energia_Activa_Importada_A }});
                                                                    values_curvashorarias_Ri.push({{ $resultado->Energia_Reactiva_Inductiva_Importada_Ri }});
                                                                    values_curvashorarias_Exportada_A.push({{ $resultado->Energia_Activa_Exportada_A }}); // Recolectar los datos de Energia_Activa_Exportada_A
                                                                @endforeach
                                                            
                                                                var sortedData = labels_curvashorarias.slice().sort();
                                                                ...
                                                                function updateChartLineCurvasHorarias(data) {
                                                                    if (myChartLineCurvasHorarias) {
                                                                        ...
                                                                        myChartLineCurvasHorarias.data.datasets[0].data = data.values_curvashorarias_Ri;
                                                                        myChartLineCurvasHorarias.data.datasets[1].data = data.values_curvashorarias_A;
                                                                        myChartLineCurvasHorarias.data.datasets[2].data = data.values_curvashorarias_Exportada_A; // Actualizar con los nuevos datos
                                                                        ...
                                                                        myChartLineCurvasHorarias = new Chart(ctx, {
                                                                            ...
                                                                            data: {
                                                                                ...
                                                                                datasets: [{
                                                                                        ...
                                                                                        data: data.values_curvashorarias_Ri,
                                                                                    ...
                                                                                    },
                                                                                    {
                                                                                        ...
                                                                                        data: data.values_curvashorarias_A,
                                                                                    ...
                                                                                    },
                                                                                    {
                                                                                        ...
                                                                                        data: data.values_curvashorarias_Exportada_A,
                                                                ...
                                                                updateChartLineCurvasHorarias({
                                                                    ...
                                                                    values_curvashorarias_A: values_curvashorarias_A,
                                                                    values_curvashorarias_Ri: values_curvashorarias_Ri,
                                                                    values_curvashorarias_Exportada_A: values_curvashorarias_Exportada_A // Pasar los nuevos datos a la función
                                                                });
                                                            </script>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                                            <div class="card text-white  mb-2 col-span-2"
                                                ...
                                                <div class="container">
                                                    <div class="table-responsive w-full"
                                                        style="display: flex; justify-content: center;">
                                                        @if (is_array($resultadosQ15pf) && count($resultadosQ15pf) > 0)
                                                            <div class="grafico-wrapper"
                                                            ...
                                                            <script>
                                                                ...
                                                                @foreach ($resultadosQ15pf as $resultado)
                                                        ...
                                                        @else
                                                            <div class="p-4 text-white rounded-lg shadow-xl">
                                                                <h2 class="text-lg text-center font-normal">
                                                                    Media de Consumo por Hora para A+ y A- </h2>
                                                                <p class="mt-2 text-xl  text-center"
                                                                    style="color:rgb(88,226,194)">No
                                                                    hay datos</p>
                                                            </div>
                                            ...
                                            <div class="card text-white  mb-2 col-span-1 w-full"
                                                ...
                                                <div class="container">
                                                    @if (is_array($resultadosQ16pf) && count($resultadosQ16pf) > 0)
                                                        ...
                                                        <div class="table-responsive w-full"
                                                            ...
                                                            <script>
                                                                ...
                                                                @foreach ($resultadosQ16pf as $resultado)
                                                        ...
                                                        @else
                                                            <div class="p-4 text-white rounded-lg shadow-xl">
                                                                <h2 class="text-lg text-center font-normal">
                                                                    Media de Consumo por Dia de la semana para A+ y
                                                                    A-
                                                                </h2>
                                                                <p class="mt-2 text-xl  text-center"
                                                                    style="color:rgb(88,226,194)">No
