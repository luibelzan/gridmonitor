            ...
            <div class="lg:ml-14 p-2 mt-0 w-full"> <!-- Añadir margen superior -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-4 mt-16 ml-14">
                    ...
                    <nav class="nav mb-12 ">
                        ...
                        <a href="{{ route('informacioncups', ['id_cups' => $id_cups, 'id_cnt' => $id_cnt]) }}"
                            class="nav-item " active-color="rgb(88, 226, 194">Información</a>
                        <a href="{{ route('curvashorariascups', ['id_cups' => $id_cups, 'id_cnt' => $id_cnt]) }}"
                            class="nav-item" active-color="rgb(88, 226, 194">Curvas Horarias</a>
                        <a href="{{ route('energiacups', ['id_cups' => $id_cups, 'id_cnt' => $id_cnt]) }}"
                            class="nav-item" active-color="rgb(88, 226, 194">Calidad Energía</a>
                        <a href="{{ route('eventoscups', ['id_cups' => $id_cups, 'id_cnt' => $id_cnt]) }}"
                            class="nav-item is-active" active-color="rgb(88, 226, 194">Eventos</a>
                                                    ...
                                                    @foreach ($resultadosQ1cups as $resultado)
                                                        <tr class="highlight-row">
                                                            <td class="py-2 px-4 text-center">
                                                                <a href="{{ route('detalleseventoscups', ['id_cups' => $resultado->id_cups, 'id_cnt' => $resultado->id_cnt]) }}"
