                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-4 mt-16 ml-14">
                    ...
                    <nav class="nav mb-12 ">
                        ...
                        <a href="{{ route('detallescurvashorariascups', ['id_cups' => $id_cups, 'id_cnt' => $id_cnt]) }}"
                            class="nav-item" active-color="rgb(88, 226, 194">Curvas Horarias</a>
                        <a href="{{ route('detallesconsumodiariocups', ['id_cups' => $id_cups, 'id_cnt' => $id_cnt]) }}"
                            class="nav-item" active-color="rgb(88, 226, 194">Consumos Diarios</a>
                        ...
                        <div class="form-group ">
                            <form action="{{ route('informacioncups') }}" method="GET">
                                ...
                                <input type="text" name="id_cups" placeholder="Buscar por ID de CUPS"
                                    ...
                                    style="background-color: transparent; border-color: rgb(255, 255, 255);" @if (isset($_GET['id_cups'])) value="{{ $_GET['id_cups'] }}" @endif>
                                {{-- buscador por contador --}}
                                <input type="text" name="id_cnt" placeholder="Buscar por ID de contador"
                                    class="border p-2 rounded-md w-52 ml-1 text-white "
                                    style="background-color: transparent; border-color: rgb(255, 255, 255);" @if (isset($_GET['id_cnt'])) value="{{ $_GET['id_cnt'] }}" @endif>
                                ...
                                <div class="form-check form-switch ml-2">
                                    <input class="form-check-input" type="checkbox" role="switch"
                                        id="flexSwitchCheckDefault" name="autoconsumo" value="S" {{ isset($_GET['autoconsumo']) && $_GET['autoconsumo'] === 'S' ? 'checked' : '' }}
                    ...
                    @if (isset($id_cups) || isset($id_cnt))
                        @if (count($resultadosQ1cups) === 0)
                            <div class="flex justify-center">
                                <div class="alert alert-danger text-center max-w-max flex items-center space-x-2" role="alert">
                        ...
                        @else
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-1 gap-6"
                                                style="background: linear-gradient(to bottom, RGB(27 32 38), RGB(27 32 38));">
                                                {{-- FILTRO FECHAS --}}
                                                <form action="{{ route('detallesinformacioncups', ['id_cups' => $id_cups]) }}" method="GET"
                                                    class="flex flex-wrap items-center justify-start gap-2 mt-6">
                                                    {{-- FILTRO FECHAS --}}
                                                    <input type="hidden" name="id_cups" value="{{ $id_cups }}">
                                                    <div class="form-group flex items-center">
                                                        <label for="consumo_fecha_inicio" class="text-white mr-2">Fecha de
                                                            inicio:</label>
                                                        <input type="date" id="consumo_fecha_inicio" name="consumo_fecha_inicio"
                                                            class="border border-gray-400 p-2 rounded-lg text-white" @if (isset($_GET['consumo_fecha_inicio']))
                                                            value="{{ $_GET['consumo_fecha_inicio'] }}" @endif max="{{ date('Y-m-d') }}"
                                                            style="background-color: transparent;">
                                                    </div>
                                                    <div class="form-group flex items-center">
                                                        <label for="consumo_fecha_fin" class="text-white mr-2">Fecha
                                                            de
                                                            fin:</label>
                                                        <input type="date" id="consumo_fecha_fin" name="consumo_fecha_fin"
                                                            class="border border-slate-900 p-2 rounded-lg text-white" @if (isset($_GET['consumo_fecha_fin'])) value="{{ $_GET['consumo_fecha_fin'] }}"
                                                            @endif max="{{ date('Y-m-d') }}" style="background-color: transparent;">
                                                    </div>
                                                    <button type="submit" class="btn btn-outline-info mb-3 text-white"
                                                        style="background-color: transparent; border-color: rgb(255, 255, 255);"
                                                        onmouseover="this.style.borderColor='rgb(88,226,194)'"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-5 gap-2 mb-6">
                                                ...
                                                <div class="card text-white mb-2 col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-2"
                                                    style="background: linear-gradient(to bottom, RGB(27 32 38), RGB(27 32 38));">
                                                    <h1 class="text-center text-2xl" style="color: white;">CONSUMOS MENSUALES</h1>
                                                    <div
                                                    ...
                                                    <div class="container">
                                                        <h2 class="text-center text-1xl mt-2" style="color: white;">
                                                            @if(request()->filled('consumo_fecha_inicio') && request()->filled('consumo_fecha_fin'))
                                                                Consumo desde {{ request('consumo_fecha_inicio') }} hasta
                                                ...
                                                <div class="table-responsive" style="display: flex; justify-content: center;">
                                                    <div class="overflow-x-auto w-full">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mb-6">
                                                            {{-- FILTRO FECHAS --}}
                                                            <form action="{{ route('detallesinformacioncups', ['id_cups' => $id_cups]) }}"
                                                                method="GET" class="flex flex-wrap items-center justify-start gap-2 mt-6">
                                                                {{-- FILTRO FECHAS --}}
                                                                <input type="hidden" name="id_cups" value="{{ $id_cups }}">
                                                                <div class="form-group flex items-center">
                                                                    ...
                                                                    <input type="date" id="fecha_inicio" name="fecha_inicio"
                                                                        class="border border-gray-400 p-2 rounded-lg text-white" @if (isset($_GET['fecha_inicio'])) value="{{ $_GET['fecha_inicio'] }}"
                                                                ...
                                                                <div class="form-group flex items-center">
                                                                    ...
                                                                    <input type="date" id="fecha_fin" name="fecha_fin"
                                                                        class="border border-slate-900 p-2 rounded-lg text-white" @if (isset($_GET['fecha_fin'])) value="{{ $_GET['fecha_fin'] }}" @endif
                                                        ...
                                                        <div class="container">
                                                            @if (count($resultadosQ5cups) > 0)
                                                                <div class="rgb(27,32,38) p-4 rounded-lg shadow-xl"
                                                                    ...
                                                                    <table id="testTableEventos" class="w-full text-white text-center  ">
