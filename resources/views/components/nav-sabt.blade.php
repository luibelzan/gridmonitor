...
<nav class="nav custom-nav mb-12">
    ...
    <a href="{{ route('indicadoressabt', ['id_ct' => $id_ct]) }}"
        class="nav-item {{ Request::is('indicadores*') ? 'is-active' : '' }}"
        active-color="rgb(88, 226, 194)">Indicadores</a>
    <a href="{{ route('supervisionavanzada', ['id_ct' => $id_ct]) }}"
        class="nav-item {{ Request::is('supervisionavanzada') ? 'is-active' : '' }}"
        active-color="rgb(88, 226, 194)">Información</a>
    <a href="{{ route('fasessabt', ['id_ct' => $id_ct]) }}" class="nav-item {{ Request::is('fases') ? 'is-active' : '' }}"
