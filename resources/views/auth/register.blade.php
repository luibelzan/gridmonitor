...
<head>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script> {{-- CHART.JS --}}
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src='https://cdn.plot.ly/plotly-2.31.1.min.js'></script> <!-- Load plotly.js into the DOM --> {{-- JAVASCRIPT --}}
                    ...
                    <div class="flex justify-center items-center h-screen">
                        <div class="border-blue-900 p-6 shadow-md sm:p-8 md:p-10 w-full max-w-md"
                            ...
                            <div class="text-center">
                                <h1 class="text-3xl text-white">REGISTRAR USUARIO</h1>
                                <div
                            ...
                            <form method="POST" action="{{ route('registro') }}">
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="name" class="block mt-1 w-full bg-gray-800 text-white"
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="email" class="block mt-1 w-full bg-gray-800 text-white"
                                ...
                                <!-- Confirm Password -->
                                <div class="mt-4">
                                    <x-input-label for="password_confirmation" :value="__('Confirma tu contraseña')" class="text-white" />
                                    <x-text-input id="password_confirmation"
                                        class="block mt-1 w-full bg-gray-800 text-white" type="password"
                                ...
                                <div class="mt-4">
                                    <x-input-label for="nom_distribuidora" :value="__('Nombre de la distribuidora')" class="text-white" />
                                    <x-text-input id="nom_distribuidora"
                                        class="block mt-1 w-full bg-gray-800 text-white" type="text"
                                        name="nom_distribuidora" :value="old('nom_distribuidora')" autofocus
                                        autocomplete="nom_distribuidora" />
                                    <x-input-error :messages="$errors->get('nom_distribuidora')" class="mt-2" />
                                </div>
                                ...
                                <!-- Código de grupo -->
                                <div class="mt-4">
                                    <x-input-label for="cod_id_group" :value="__('Código de grupo')" class="text-white" />
                                    <x-text-input id="cod_id_group" class="block mt-1 w-full bg-gray-800 text-white"
                                        type="text" name="cod_id_group" :value="old('cod_id_group')" autofocus
                                        autocomplete="cod_id_group" />
                                    <x-input-error :messages="$errors->get('cod_id_group')" class="mt-2" />
                                </div>
                                ...
                                <div class="mt-4">
                                    <label for="ind_pf" class="text-white custom-checkbox">
                                        <input type="checkbox" id="ind_pf" name="ind_pf"
                                            {{ old('ind_pf') ? 'checked' : '' }}
                                            class="bg-gray-800 px-4 py-2 rounded-md mr-2">
                                        Indicador PF
                                    </label><br>
                                    ...
                                    <label for="ind_sabt" class="text-white custom-checkbox">
                                        <input type="checkbox" id="ind_sabt" name="ind_sabt"
                                            {{ old('ind_sabt') ? 'checked' : '' }}
                                            class="bg-gray-800 px-4 py-2 rounded-md mr-2">
                                        Indicador SABT
                                    </label><br>
                                    <label for="ind_ws" class="text-white custom-checkbox">
                                        <input type="checkbox" id="iind_ws" name="ind_ws"
                                            {{ old('ind_ws') ? 'checked' : '' }}
                                            class="bg-gray-800 px-4 py-2 rounded-md mr-2">
                                        Indicador WS
                                    </label><br>
                                ...
                                <div class="flex items-center justify-end mt-4">
                                    ...
                                    <x-primary-button
                                        class="bg-custom hover:bg-custom text-white  py-2 px-4 rounded-md">
                                        {{ __('Registrar') }}
                                    </x-primary-button>
                                </div>
                            </form>
