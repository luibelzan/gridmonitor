    ...
    */
    ...
    'connections' => [
        ...
        'mysql_exports' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_MYSQL_EXPORTS_HOST', '127.0.0.1'),
            'port' => env('DB_MYSQL_EXPORTS_PORT', '3306'),
            'database' => env('DB_MYSQL_EXPORTS_DATABASE', 'laravel'),
            'username' => env('DB_MYSQL_EXPORTS_USERNAME', 'root'),
            'password' => env('DB_MYSQL_EXPORTS_PASSWORD', ''),
